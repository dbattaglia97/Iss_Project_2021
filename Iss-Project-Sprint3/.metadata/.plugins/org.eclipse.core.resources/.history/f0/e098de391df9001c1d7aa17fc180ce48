		...
		return { //this:ActionBasciFsm
				...
				state("increasing") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t049",targetState="increasing",cond=whenTimeout("local_tout_thermometer_increasing"))   
					transition(edgeName="t050",targetState="decreasing",cond=whenEvent("decrease"))
				}	 
				state("decreasing") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t051",targetState="decreasing",cond=whenTimeout("local_tout_thermometer_decreasing"))   
					transition(edgeName="t052",targetState="increasing",cond=whenEvent("increase"))
				}	 
			}
		}
}
