...
package it.unibo.parkingmanagerservive
...
class Parkingmanagerservive ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_s0", 
							scope, context!!, "local_tout_parkingmanagerservive_s0", 1000.toLong() )
					}
					 transition(edgeName="t017",targetState="checkAcceptIN",cond=whenTimeout("local_tout_parkingmanagerservive_s0"))   
				}	 
				...
				state("indoorOnlyReady") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_indoorOnlyReady", 
							scope, context!!, "local_tout_parkingmanagerservive_indoorOnlyReady", 10000.toLong() )
					}
					 transition(edgeName="t018",targetState="moveToHome",cond=whenTimeout("local_tout_parkingmanagerservive_indoorOnlyReady"))   
				...
				state("outdoorOnlyReady") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_outdoorOnlyReady", 
							scope, context!!, "local_tout_parkingmanagerservive_outdoorOnlyReady", 10000.toLong() )
					}
					 transition(edgeName="t020",targetState="moveToHome",cond=whenTimeout("local_tout_parkingmanagerservive_outdoorOnlyReady"))   
				...
				state("waiting") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_waiting", 
							scope, context!!, "local_tout_parkingmanagerservive_waiting", 5000.toLong() )
					}
					 transition(edgeName="t022",targetState="moveToHome",cond=whenTimeout("local_tout_parkingmanagerservive_waiting"))   
				}	 
				state("moveToHome") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t023",targetState="trolleyIsHome",cond=whenEvent("finishedPath"))
				}	 
				state("trolleyIsHome") { //this:State
					action { //it:State
				...
				state("allReady") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t024",targetState="acceptin",cond=whenRequest("reqenter"))
					transition(edgeName="t025",targetState="acceptout",cond=whenRequest("pickup"))
				}	 
				state("acceptin") { //this:State
					action { //it:State
					 ...
					 transition( edgeName="goto",targetState="moveToIn", cond=doswitchGuarded({notAllowed==false 
					}) )
				...
				state("moveToIn") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t026",targetState="trolleyIsInIndoor",cond=whenEvent("finishedPath"))
				}	 
				state("trolleyIsInIndoor") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t027",targetState="carenter",cond=whenRequest("carenter"))
				}	 
				state("carenter") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t028",targetState="weightCheck",cond=whenDispatch("weightcheck"))
				}	 
				...
				state("receipt") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_receipt", 
							scope, context!!, "local_tout_parkingmanagerservive_receipt", 1000.toLong() )
					}
					 transition(edgeName="t029",targetState="moveToSlotIn",cond=whenTimeout("local_tout_parkingmanagerservive_receipt"))   
				}	 
				state("moveToSlotIn") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t030",targetState="trolleyIsInSlot",cond=whenEvent("finishedPath"))
				}	 
				...
				state("goToSlot") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t031",targetState="picking",cond=whenEvent("finishedPath"))
				}	 
				...
				state("moveToOut") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t032",targetState="trolleyIsInOutdoor",cond=whenEvent("finishedPath"))
				}	 
				state("trolleyIsInOutdoor") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="withdrawn",cond=whenDispatch("withdrawn"))
