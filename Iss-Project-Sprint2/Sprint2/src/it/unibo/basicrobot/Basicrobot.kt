		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t138",targetState="exec",cond=whenDispatch("cmd"))
					transition(edgeName="t139",targetState="doStep",cond=whenRequest("step"))
					transition(edgeName="t140",targetState="handleObstacle",cond=whenDispatch("obstacle"))
					transition(edgeName="t141",targetState="endwork",cond=whenDispatch("end"))
				}	 
				...
				state("doStep") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t042",targetState="stepDone",cond=whenTimeout("local_tout_basicrobot_doStep"))   
					transition(edgeName="t043",targetState="stepFail",cond=whenDispatch("obstacle"))
				}	 
