		...
		return { //this:ActionBasciFsm
				...
				state("doMove") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t136",targetState="execPlannedMoves",cond=whenTimeout("local_tout_trolley_doMove"))   
					transition(edgeName="t137",targetState="working",cond=whenDispatchGuarded("trolleycmd",{home == 1 && terminate == 0 
					}))
				}	 
